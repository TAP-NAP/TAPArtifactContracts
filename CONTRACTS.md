...
| Capture binding and proof | `bindings/capture-binding-and-proof-v1.md` | Canonical bytes, family hash participation, producer signing, local reconstruction, App Attest assertion verification, signed resources | App Attest key lifecycle and server deployment |
