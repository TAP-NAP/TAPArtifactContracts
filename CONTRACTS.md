...
| TAP Video capture telemetry | [`containers/tap-video-capture-telemetry-v1.md`](containers/tap-video-capture-telemetry-v1.md) | Optional independently versioned UUID, filtering observations and bounded device-motion samples | Capture scheduling, stabilization and display processing |
